                  ...
                  Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                              "Horas/Minutos Trabalhadas(os):  " +
                                      contatos[index].HT ??
                                  "",
                              style: TextStyle(fontSize: 15)),
                          Text(
                              "Lucro Esperado: R\$ " +
                                      contatos[index].LE.toStringAsFixed(2) ??
                                  "",
                              style: TextStyle(fontSize: 15)),
                          Text(
                              "Valor Liquido: R\$ " +
                                      contatos[index].VL.toStringAsFixed(2) ??
                                  "",
                              style: TextStyle(fontSize: 15)),
                          Text(
                              "Estoque: " + contatos[index].ES.toString() ?? "",
                              style: TextStyle(fontSize: 15)),
                          Text(
                              "Tecido quant/custo: " + contatos[index].TEC ??
                                  "",
                              style: TextStyle(fontSize: 15)),
                          Text(
                              "Elastico quant/custo: " + contatos[index].ELA ??
                                  "",
                              style: TextStyle(fontSize: 15)),
                          Text(
